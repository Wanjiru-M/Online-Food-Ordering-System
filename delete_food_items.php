...
if (mysqli_num_rows($result) > 0)
{
  ...
  <?php } ?>
    ...
    <br>
        ...
        <button type="submit" id="submit" name="delete" value="Delete" class="btn btn-danger pull-right" onclick="return confirm('Are you sure you want to delete?')">DELETE</button>
