...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<!-- <a href="add_food_items.php" class="list-group-item activ"></a> -->
    ...
    <div class="col-xs-9">
      ...
      <form action="add_food_items1.php" method="POST" enctype="multipart/form-data">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
    <input type="text" class="form-control" id="price" name="price" placeholder="Your Food Price (KSH)" required>
</div>
